...
class UserApi
{
     ...
     * @return \YNAB\Model\UserResponse|\YNAB\Model\ErrorResponse
     */
     ...
     * @throws \YNAB\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \YNAB\Model\UserResponse|\YNAB\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getUserWithHttpInfo()
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\YNAB\Model\UserResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\YNAB\Model\UserResponse', []),
