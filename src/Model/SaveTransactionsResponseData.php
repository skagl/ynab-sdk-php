...
class SaveTransactionsResponseData implements ModelInterface, ArrayAccess
{
     ...
     * Gets transaction
     *
     * @return \YNAB\Model\TransactionDetail|null
     */
     ...
     * Sets transaction
     *
     * @param \YNAB\Model\TransactionDetail|null $transaction transaction
     *
     * @return $this
     */
     ...
     * Sets transactions
     *
     * @param \YNAB\Model\TransactionDetail[]|null $transactions If multiple transactions were specified, the transactions that were saved
     *
     * @return $this
     */
     ...
     *
     * @param string[]|null $duplicateImportIds If multiple transactions were specified, a list of import_ids that were not created because of an existing import_id found on the same account
     *
     * @return $this
     */
